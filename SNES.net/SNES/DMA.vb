                    ...
                    While .Counter
                        ...
                        For i As Integer = 0 To Size - 1
                            ...
                            If .Params And &H80 Then
                                Parent.CPU.Write8(.DMACurr, Parent.PPU.Read8(.PPUAddr + PPUInc), False)
                            Else
                                Parent.PPU.Write8(.PPUAddr + PPUInc, Parent.CPU.Read8(.DMACurr, False))
                            End If
                    ...
                    If .Enabled Then
                        If (.HDMALine And &H7F) = 0 Or .HDMALine > &H80 Then
                            ...
                            For i As Integer = 0 To Size - 1
                                ...
                                If .Params And &H80 Then
                                    Parent.CPU.Write8(AAddr, Parent.PPU.Read8(.PPUAddr + PPUInc), False)
                                Else
                                    Parent.PPU.Write8(.PPUAddr + PPUInc, Parent.CPU.Read8(AAddr, False))
                                End If
